...
public class RenderAirDrop extends Render {
    ...
    private void doRenderFallingSand(EntityAirDrop entity, double x, double y, double z, float f, float f2) {
        ...
        Block block = Block.getBlockById(entity.blockID);

        if (world.getBlock(MathHelper.floor_double(entity.posX), MathHelper.floor_double(entity.posY), MathHelper.floor_double(entity.posZ)) != Block.getBlockById(entity.blockID)) {
            GL11.glPushMatrix();
