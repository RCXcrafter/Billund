...
public class BillundProxyClient extends BillundProxyCommon {
    ...
    public void init() {
        ...
        // Setup renderers
        Billund.BillundBlocks.billund.blockRenderID = RenderingRegistry.getNextAvailableRenderId();
    ...
    private void registerForgeHandlers() {
        ...
        MinecraftForgeClient.registerItemRenderer(Billund.BillundItems.brick, brickHandler);
        ...
        public void onRenderTick(TickEvent.RenderTickEvent event) {
            if (event.phase == TickEvent.Phase.START) {
                ...
                if (player != null && world != null) {
                    BlockBillund.setHoverBrick(ItemBrick.getExistingBrick(world, player, event.renderTickTime));
                } else {
    ...
    private static class BillundBlockRenderingHandler implements ISimpleBlockRenderingHandler {

        @Override
        public int getRenderId() {
            return Billund.BillundBlocks.billund.blockRenderID;
        }
    ...
    private static void renderBrick(IBlockAccess world, int brightness, int colour, int sx, int sy, int sz, int width, int height, int depth) {
        // Draw the brick
        IIcon IIcon = BlockBillund.getIcon(colour);
        if (world != null) {
            Tessellator tessellator = Tessellator.instance;
    ...
    private static void renderBox(IIcon IIcon, int brightness, float startX, float startY, float startZ, float endX, float endY, float endZ, boolean bottom) {
        // X faces
        renderFaceXNeg(IIcon, startX, startY, startZ, endX, endY, endZ);
        renderFaceXPos(IIcon, startX, startY, startZ, endX, endY, endZ);

        // Y faces
        if (bottom) {
            renderFaceYNeg(IIcon, startX, startY, startZ, endX, endY, endZ);
        }
        renderFaceYPos(IIcon, startX, startY, startZ, endX, endY, endZ);

        // Z faces
        renderFaceZNeg(IIcon, startX, startY, startZ, endX, endY, endZ);
        renderFaceZPos(IIcon, startX, startY, startZ, endX, endY, endZ);
    }

    private static void renderFaceXNeg(IIcon IIcon, float startX, float startY, float startZ, float endX, float endY, float endZ) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setColorOpaque_F(0.6f, 0.6f, 0.6f);
        tessellator.addVertexWithUV(startX, endY, endZ, IIcon.getMinU(), IIcon.getMaxV());
        tessellator.addVertexWithUV(startX, endY, startZ, IIcon.getMinU(), IIcon.getMinV());
        tessellator.addVertexWithUV(startX, startY, startZ, IIcon.getMaxU(), IIcon.getMinV());
        tessellator.addVertexWithUV(startX, startY, endZ, IIcon.getMaxU(), IIcon.getMaxV());
    }

    private static void renderFaceXPos(IIcon IIcon, float startX, float startY, float startZ, float endX, float endY, float endZ) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setColorOpaque_F(0.6f, 0.6f, 0.6f);
        tessellator.addVertexWithUV(endX, startY, endZ, IIcon.getMaxU(), IIcon.getMaxV());
        tessellator.addVertexWithUV(endX, startY, startZ, IIcon.getMaxU(), IIcon.getMinV());
        tessellator.addVertexWithUV(endX, endY, startZ, IIcon.getMinU(), IIcon.getMinV());
        tessellator.addVertexWithUV(endX, endY, endZ, IIcon.getMinU(), IIcon.getMaxV());
    }

    private static void renderFaceYNeg(IIcon IIcon, float startX, float startY, float startZ, float endX, float endY, float endZ) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setColorOpaque_F(0.5f, 0.5f, 0.5f);
        tessellator.addVertexWithUV(startX, startY, endZ, IIcon.getMinU(), IIcon.getMaxV());
        tessellator.addVertexWithUV(startX, startY, startZ, IIcon.getMinU(), IIcon.getMinV());
        tessellator.addVertexWithUV(endX, startY, startZ, IIcon.getMaxU(), IIcon.getMinV());
        tessellator.addVertexWithUV(endX, startY, endZ, IIcon.getMaxU(), IIcon.getMaxV());
    }

    private static void renderFaceYPos(IIcon IIcon, float startX, float startY, float startZ, float endX, float endY, float endZ) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setColorOpaque_F(1.0f, 1.0f, 1.0f);
        tessellator.addVertexWithUV(endX, endY, endZ, IIcon.getMaxU(), IIcon.getMaxV());
        tessellator.addVertexWithUV(endX, endY, startZ, IIcon.getMaxU(), IIcon.getMinV());
        tessellator.addVertexWithUV(startX, endY, startZ, IIcon.getMinU(), IIcon.getMinV());
        tessellator.addVertexWithUV(startX, endY, endZ, IIcon.getMinU(), IIcon.getMaxV());
    }

    private static void renderFaceZNeg(IIcon IIcon, float startX, float startY, float startZ, float endX, float endY, float endZ) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setColorOpaque_F(0.8f, 0.8f, 0.8f);
        tessellator.addVertexWithUV(startX, endY, startZ, IIcon.getMaxU(), IIcon.getMaxV());
        tessellator.addVertexWithUV(endX, endY, startZ, IIcon.getMaxU(), IIcon.getMinV());
        tessellator.addVertexWithUV(endX, startY, startZ, IIcon.getMinU(), IIcon.getMinV());
        tessellator.addVertexWithUV(startX, startY, startZ, IIcon.getMinU(), IIcon.getMaxV());
    }

    private static void renderFaceZPos(IIcon IIcon, float startX, float startY, float startZ, float endX, float endY, float endZ) {
        Tessellator tessellator = Tessellator.instance;
        tessellator.setColorOpaque_F(0.8f, 0.8f, 0.8f);
        tessellator.addVertexWithUV(startX, startY, endZ, IIcon.getMinU(), IIcon.getMaxV());
        tessellator.addVertexWithUV(endX, startY, endZ, IIcon.getMinU(), IIcon.getMinV());
        tessellator.addVertexWithUV(endX, endY, endZ, IIcon.getMaxU(), IIcon.getMinV());
        tessellator.addVertexWithUV(startX, endY, endZ, IIcon.getMaxU(), IIcon.getMaxV());
    }
}
